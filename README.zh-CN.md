...
对于 1.3.3 打包候选，执行 `pwsh -NoProfile -File scripts/package.ps1 -Version 1.3.3`，检查 `dist/manifest.json` 和 `dist/SHA256SUMS.txt`，再遵循宿主的安装文档。生成归档不等于 Codex 或其他宿主已经安装它，也不代表 1.3.3 已公开发布。
