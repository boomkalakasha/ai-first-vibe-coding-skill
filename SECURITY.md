...
Security fixes are provided for the latest published release. Older versions may receive a migration recommendation instead of a patch.
...
Relevant reports include unsafe release workflows, secret exposure, instruction paths that authorize destructive or external actions without consent, archive traversal, and validation bypasses. Model disagreement or an undocumented host integration is normally a compatibility issue unless it creates a concrete security impact.
